import { multipartFormRequestOptions, createForm } from 'googletranslate/core';
import { Blob } from 'googletranslate/_shims/index';
import { toFile } from 'googletranslate';
